...
const ProductChoiceBlackGray: React.FC<ProductChoiceProps> = ({product1, product2, currentProductTitle}) => {
    ...
    return (
        <section className="relative pt-12 pb-12 md:pt-32 md:pb-20 tracking-tight leading-6 text-neutral-100 bg-mask-black"
                 >
            <div className="grain">
...
export default ProductChoiceBlackGray;