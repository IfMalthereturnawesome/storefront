...
const MobileFaceStory: React.FC<FaceStoryProps> = ({headline, description, imageSrc = "", imageSrcTwo  =""}) => {
    return (
        <div className="flex flex-col h-auto md:flex-row bg-[#130612] z-[1] relative pb-12 pt-6">
            {/* Images */}
            <div className="flex w-full md:w-[49vw] items-center justify-center md:justify-start pb-6 space-y-4">
