...
const ProductChoiceBlackBlue: React.FC<ProductChoiceProps> = ({product1, product2, currentProductTitle}) => {
    ...
    return (
        <section className="relative pt-12 pb-12 md:pt-32 md:pb-20 tracking-tight leading-6 text-neutral-100 bg-cyan-1"
            ...
            <div
                ...
                <div className="rounded-[2.5rem] shadow shadow-amberA-10 dark:shadow-amberA-12 bg-mask-black">
...
export default ProductChoiceBlackBlue;