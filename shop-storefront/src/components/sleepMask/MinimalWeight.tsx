...
const MinimalWeight: React.FC<MinimalWeightProps> = ({setShouldPlayParticles}) => {
    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            let initialFallingCompleteLeft = false;
            let initialFallingCompleteRight = false;
            ...
            makeRightSideTurn.current
                .to(rightSideRef.current, {
                    ...
                    onComplete: () => {
                        gsap.set([leverRef.current, rightSideRef.current, topTextToMorphRef.current, bottomTextToMorphRef.current], {
                            willChange: "auto"
                        });
                        ...
                        <div id="leverWrapper" className="relative w-[850px] h-[890px] z-0 mt-48">
                            ...
                            <div ref={leftSideRef}
                                ...
                                <svg width="239.295" height="31.512" viewBox="0 0 239.295 31.512"
                                     xmlns="http://www.w3.org/2000/svg" className={"z-[1]"}>
                            ...
                            <div id="morphedText"
                                ...
                                <svg width="239.295" height="31.512" viewBox="0 0 239.295 30.512"
                                     xmlns="http://www.w3.org/2000/svg">

                                    <g id="svgMorph" strokeLinecap="round" fillRule="nonzero" fontSize="9pt"
                                       stroke="#faf7f7" strokeWidth="0.25mm"
                                       style={{stroke: "#faf7f7", fill: "#faf7f7"}}>
                                        <path ref={bottomTextToMorphRef} style={{willChange: "d"}}
