...
const ParticlesBackground = ({shouldPlayParticles}) => {
    ...
    const [individualParticleOptions, setIndividualParticleOptions] = useState({
        ...
        shape: {
            ...
            image: [
                {
                    src: "/images/dandelion-seed-one.png", // Path to first dandelion seed image
                    width: 100,
                    height: 100,
                },
                {
                    src: "/images/dandelion-seed-four.png", // Path to second dandelion seed GIF
                    width: 100,
                    height: 100,
                },
        ...
        particles: {
            ...
            shape: {
                ...
                image: [
                    ...
                    {
                        src: "/images/dandelion-seed-three.png", // Path to second dandelion seed GIF
                        width: 500,
                        height: 500,
                    },
