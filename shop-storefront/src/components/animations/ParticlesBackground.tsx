...
// Use a useEffect hook for cleanup
    useEffect(() => {
        return () => {
            if (intervalIdRef.current) clearInterval(intervalIdRef.current as any);
