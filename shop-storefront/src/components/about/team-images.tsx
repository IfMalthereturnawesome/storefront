      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto">
          <div className="relative w-full h-0 pb-3/4">
            ...
            <figure className="absolute mx-auto h-auto" style={{ top: '50%', left: '65%', width: '49.52%', maxWidth: '212px' }} data-aos="fade-down" data-aos-delay="100">
            ...
            <figure className="absolute h-auto" style={{ bottom: '10%', right: '0', width: '35.52%', maxWidth: '212px' }} data-aos="fade-up" data-aos-delay="300">
              <Image src={lasseBikingFast} width="250" height="250" alt="Team mosaic 04" />
            </figure>
            <figure className="absolute h-auto" style={{ bottom: '0', right: '39%', width: '45.52%', maxWidth: '212px' }} data-aos="fade-up" data-aos-delay="300">
