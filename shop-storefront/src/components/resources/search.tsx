...
export default function Search() {
  ...
  return (
    <div className=" mx-4 md:mx-4">
      <button
        className="w-full sm:w-[150px] text-[15px] bg-white text-slate-400 inline-flex items-center justify-between leading-5 pl-3 pr-2 py-[7px] rounded border border-slate-200 hover:border-slate-300 shadow-sm whitespace-nowrap dark:text-slate-500 dark:bg-cyan-3 dark:border-slate-700 dark:hover:border-slate-600"
        onClick={(e) => {
          e.stopPropagation()
