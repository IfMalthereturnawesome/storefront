...
export default function SearchModal({
  ...
  const [groupedResourceSearchResults, setGroupedResourceSearchResults] =
    useState<Record<string, Resource[]>>({}); // {topic: [resources]}

  const [groupedBlogSearchResults, setGroupedBlogSearchResults] = useState<
    Record<string, Post[]>
  >({}); // {topic: [posts]}
                    ...
                    <ul>
                      {resources.map(resource => (
                        ...
                        >
                          ...
                          <Link href={`/resources/${resource.slug}`} onClick={() => setModalOpen(false)}>
                            {resource.title}
                          </Link>
