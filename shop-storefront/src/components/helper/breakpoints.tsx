...
const BreakpointsIndicator: React.FC = () => {
    return (
        <div className="fixed z-50 top-0 left-0 m-8 p-3 text-xs font-mono text-white h-7 w-7 rounded-full shadow-md border-white border flex items-center justify-center
            ...
            <div className="block 2xs:hidden 3xs:hidden xs:hidden sm:hidden md:hidden lg:hidden xl:hidden 2xl:hidden 3xl:hidden">3xs</div>
