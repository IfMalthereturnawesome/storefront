    ...
    <html lang="en" className="dark" >
      ...
      <PHProvider>
        ...
        >
          ...
          <ProvidersNextUI>
            <Providers>
              <div className="flex md:border-2  border-black dark:border-[#FEE7B3] min-h-screen flex-col  ">
                {children}
              </div>
            </Providers>
          </ProvidersNextUI>
          ...
          <noscript
            dangerouslySetInnerHTML={{
              __html: `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TRH2KS6X" height="0" width="0" style="display: none; visibility: hidden;"></iframe>`,
            }}
          />
        </body>
      </PHProvider>
