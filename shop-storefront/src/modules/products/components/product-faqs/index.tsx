...
const ProductFAQ: React.FC<ProductFAQProps> = ({productFAQ, shippingFAQ, returnFAQ}) => {
    return (
        <div className="mx-auto px-vw-8 pb-vw-10  bg-gradient-to-r from-cyan-2 to-cyan-1 dark:from-cyan-3 dark:to-cyan-1  z-0">

            <div className="lg:flex justify-center items-center text-center mb-4 mt-4 lg:mt-6 lg:mb-8">
            ...
            <div className="lg:flex lg:flex-wrap">
                <div className="lg:w-1/3 p-2 mb-5 lg:mb-0">
                    <div className="mb-4 ml-3 lg:ml-0 px-vw-3 text-xl font-medium">Returns</div>
                ...
                <div className="lg:w-1/3 p-2 mb-5 lg:mb-0">
                    <div className="mb-4 ml-3 lg:ml-0 px-vw-3 text-xl font-medium">Shipping </div>
                ...
                <div className="lg:w-1/3 p-2 mb-5 lg:mb-0">
                    <div className="mb-4 ml-3 lg:ml-0 px-vw-3 text-xl font-medium">Product </div>
            ...
            <div className="mt-8 lg:mb-2 text-center">
